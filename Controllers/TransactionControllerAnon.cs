...
//    [ApiController]
//    [AllowAnonymous]
//    [Route("transaction-anon")]
//    public class TransactionControllerAnon : ControllerBase
//    {
//        private TransactionService TransactionService { get; set; }
//        private MoneyFlowService MoneyFlowService { get; set; }
//        public TransactionControllerAnon(TransactionService transactionService, MoneyFlowService moneyFlowService)
//        {
...
//        [HttpGet("{userId}")]
//        public ActionResult<GetTransactions> Get(string userId)
//        {
...
//        [HttpPost("{userId}/buy")]
//        public IActionResult PostBuyStocks(string userId, PostNewTransaction request)
//        {
...
//        public IActionResult PostSellStocks(string userId, PostNewTransaction request)
//        {
